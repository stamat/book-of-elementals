...
| `<rearrange-elemental>` | No APG pattern — a list or a table body the reader rearranges by hand: the move buttons first, because [WCAG 2.2 SC 2.5.7](https://www.w3.org/WAI/WCAG22/Understanding/dragging-movements.html) asks for the non-drag path, and pointer dragging as the option on top |
