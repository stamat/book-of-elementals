...
| `<marquee-elemental>`    | No APG pattern — a strip that loops, with the copies counted against the container, kept out of the tab order and not out of reach of the pointer, and the [stop button](https://www.w3.org/WAI/WCAG22/Understanding/pause-stop-hide.html) every other marquee leaves you to write |
