Below is every documentation page of the `book-of-elementals` npm package,
...
instantiate and no init call.

Code samples are authoritative for the current release. Repository and issues:
<https://github.com/stamat/book-of-elementals>. The link index for this site is
at <https://stamat.github.io/book-of-elementals/llms.txt>.
